...
import com.goaltracker.data.QuestRequirementResolver;
...
/**
 * Tests for {@link GoalTrackerApiImpl#addQuestGoalWithPrereqs}, the
...
class AddQuestGoalWithPrereqsTest
{
	...
	void resolveQuestRequirementsRoutesToResolver()
	{
		...
		GoalTrackerApiImpl apiWithClient = new GoalTrackerApiImpl(
			store,
