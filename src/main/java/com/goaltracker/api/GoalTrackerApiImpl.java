...
public class GoalTrackerApiImpl implements GoalTrackerApi, GoalTrackerInternalApi
{
	...
	@Override public com.goaltracker.data.QuestRequirementResolver.Resolved resolveQuestRequirements(Quest quest) { return relationService.resolveQuestRequirements(quest); }
	 ...
	 * via {@link com.goaltracker.command.CommandHistory#execute} so it lands on the undo stack.
	 */
